...
module.exports = class Command {
  ...
  async getBoilerplate(file) {
    ...
    const boilerplate = {
      ...
      usage: (boilerplateConfig && boilerplateConfig.usage),
    };
  ...
  async printUsage() {
    ...
    switch (typeof this.boilerplate.usage) {
      case 'function':
        await this.boilerplate.usage(this);
        break;
      case 'string':
        console.log(this.boilerplate.usage);
        break;
      default:
