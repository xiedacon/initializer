...
module.exports = class Command {
  ...
  async askForBoilerplate() {
    ...
    return await this.mergeBoilerplate(this.boilerplates[answers.boilerplate]);
  }
  ...
  async askForVariables() {
    return this.boilerplate.variables.length === 0
      ? {}
      : await inquirer.prompt(this.boilerplate.variables);
  }
